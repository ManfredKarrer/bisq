...
@Slf4j
public class DaoMonitorP2PService implements SetupListener, PersistedDataHost {
    private final NetworkNode networkNode;
    @Getter
    private final P2PDataStorage p2PDataStorage;
    private final DaoMonitorRequestManager requestDataManager;
    ...
    @Inject
    public DaoMonitorP2PService(NetworkNode networkNode,
                                P2PDataStorage p2PDataStorage,
                                DaoMonitorRequestManager requestDataManager,
