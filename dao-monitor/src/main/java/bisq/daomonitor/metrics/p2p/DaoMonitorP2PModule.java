...
public class DaoMonitorP2PModule extends P2PModule {

    public DaoMonitorP2PModule(Environment environment) {
        super(environment);
    }
    ...
    protected void configure() {
        ...
        bind(DaoMonitorP2PService.class).in(Singleton.class);
