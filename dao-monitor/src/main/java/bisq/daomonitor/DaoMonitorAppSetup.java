...
import bisq.daomonitor.metrics.p2p.DaoMonitorP2PService;

@Slf4j
public class DaoMonitorAppSetup {
    private DaoMonitorP2PService seedNodeDaoMonitorP2PService;
    ...
    @Inject
    public DaoMonitorAppSetup(DaoMonitorP2PService seedNodeDaoMonitorP2PService,
                              WalletsSetup walletsSetup,
                              PeerManager peerManager,
                              KeyRing keyRing,
                              EncryptionService encryptionService) {
        this.seedNodeDaoMonitorP2PService = seedNodeDaoMonitorP2PService;
    ...
    public void initPersistedDataHosts() {
        ...
        persistedDataHosts.add(seedNodeDaoMonitorP2PService);
    ...
    protected void initBasicServices() {
        SetupUtils.readFromResources(seedNodeDaoMonitorP2PService.getP2PDataStorage()).addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                seedNodeDaoMonitorP2PService.start(new SetupListener() {
